...
namespace fees_proj
{
    class Program
    {
        ...
        {
            using (fees_and_facilitiesEntities1 context = new fees_and_facilitiesEntities1())
            {
     ...
     roomFacilityList.Add(new room_facility_data("Uğursal", "Double room", "Kitchenette", "Flats"));
        ...
        static void facilities_and_options_data()
        {
            ...
            facilityList.Add(new facility_data(
                                "./Dormitories_files/airCondition.png",
            ...
            option_list = new ArrayList();
            facilityList.Add(new facility_data(
                                   "./Dormitories_files/refridgerator.png",
                                "Refrigerator",
                                "Buzdolabı",
                               option_list));
            ...
            option_list = new ArrayList();
            facilityList.Add(new facility_data(
                                "./Dormitories_files/centralsetellite.png",
                                "Room tel.",
                                "Oda Telefonmu",
                               option_list));
            ...
            option_list = new ArrayList();
            facilityList.Add(new facility_data(
                              "./Dormitories_files/microwave.png",
                                "Laundry",
                                "Çamaşırhane",
                               option_list));
            ...
            facilityList.Add(new facility_data(
                                 "./Dormitories_files/internet_wifi.png",
                               "Internet",
                                "Internet",
                               option_list));
            ...
            facilityList.Add(new facility_data(
                                "./Dormitories_files/wardrope.png",
                                   "Bed",
                                "Yatak Türü",
            ...
            option_list.Add(new facility_options("Flats", "Katta"));
            facilityList.Add(new facility_data(
                                 "./Dormitories_files/wc-shower.png",
                               "WC-shower",
                                "WC - Duş",
                               option_list));
